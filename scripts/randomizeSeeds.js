...
function randomID() {
    return Math.floor(
        Math.random() * (9999999999999999999 - 100000000000000000 + 1) +
            100000000000000000
    );
}
...
function randomArgs() {
    ...
    document.getElementById("tagscriptArgs").value =
        argsValues[Math.floor(Math.random() * argsValues.length)];
}

function randomChannel() {
    let channelNameValues = [
        "tagscript-chat",
    ...
    document.getElementById("channelName").value =
        channelNameValues[Math.floor(Math.random() * channelNameValues.length)];

    let channelID = randomID();
    document.getElementById("channelID").value = channelID;

    let channelNSFWValues = ["true", "false"];
    document.getElementById("channelNSFW").value =
        channelNSFWValues[Math.floor(Math.random() * channelNSFWValues.length)];

    document.getElementById("channelMention").value = "<#" + channelID + ">";

    let channelTopicValues = [
    ...
    document.getElementById("channelTopic").value =
        channelTopicValues[
            Math.floor(Math.random() * channelTopicValues.length)
        ];

    let channelSlowmodeValues = [
        "0",
        "5",
        "30",
        "60",
    ...
    document.getElementById("channelSlowmode").value =
        channelSlowmodeValues[
            Math.floor(Math.random() * channelSlowmodeValues.length)
        ];
}
...
function randomUser() {
    ...
    document.getElementById("userName").value =
        userNameValues[Math.floor(Math.random() * userNameValues.length)];
    ...
    document.getElementById("userCreatedAt").value = Math.floor(
        Math.random() * (Math.floor(Date.now() / 1000) - 0 + 1) + 0
    );

    document.getElementById("userJoinedAt").value = Math.floor(
        Math.random() * (Math.floor(Date.now() / 1000) - 0 + 1) + 0
    );

    document.getElementById("userMention").value = "<@" + userID + ">";

    document.getElementById("userColor").value = Math.floor(
...
function randomTarget() {
    ...
    document.getElementById("targetName").value =
        targetNameValues[Math.floor(Math.random() * targetNameValues.length)];
    ...
    document.getElementById("targetCreatedAt").value = Math.floor(
        Math.random() * (Math.floor(Date.now() / 1000) - 0 + 1) + 0
    );

    document.getElementById("targetJoinedAt").value = Math.floor(
        Math.random() * (Math.floor(Date.now() / 1000) - 0 + 1) + 0
    );

    document.getElementById("targetMention").value = "<@" + targetID + ">";

    document.getElementById("targetColor").value = Math.floor(
        Math.random() * 16777215
    )
        .toString(16)
        .toUpperCase();
